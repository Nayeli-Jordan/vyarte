...
?>
<div id="reviews" class="woocommerce-Reviews row row-complete clear">
		...
		<div id="review_form_wrapper" class="col s12 m6">
			<div id="review_form">
				<?php
					...
					$comment_form['comment_field'] .= '<p>Tu dirección de correo electrónico no será publicada. Los campos obligatorios están marcador con *</p><br><p class="comment-form-comment"><label for="comment">' . esc_html__( 'Your review', 'woocommerce' ) . '&nbsp;<span class="required">*</span></label><textarea id="comment" name="comment" cols="45" rows="8" required></textarea></p>';
	...
	<?php endif; ?>
	<div id="comments" class="col s12 m6">
