<?php get_header(); 
	if (have_posts()) : while (have_posts()) : the_post();?>
		...
		<?php if( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['btnSubmitContact'] )){
			...
			$message 		   .= '<h1 style="display: block; margin-bottom: 20px; text-align: center;  font-size: 20px; font-weight: 700; color: #00B4EF; text-transform: uppercase;">Contacto Diseño Gráfico</h1>';
